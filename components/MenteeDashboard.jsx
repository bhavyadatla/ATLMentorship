...
const MenteeDashboard = ({ currentUser, onLogout }) => {
  const [activeTab, setActiveTab] = useState("overview")

  const handleNavigate = (tabId) => {
    setActiveTab(tabId)
    // You can add more navigation logic here based on your routing needs
  }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <Footer isLoggedIn={true} currentUser={currentUser} onNavigate={handleNavigate} onLogout={onLogout} />
    </div>
  )
}
